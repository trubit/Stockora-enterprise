...
async function seed() {
  ...
  const plansToSeed = [
    {
      ...
      slug: 'free',
      tier: 'FREE',
      description: 'Ideal for solo entrepreneurs and test installations.',
      price: 0,
      ...
      limits: {
        users: { count: 2, unlimited: false },
        branches: { count: 1, unlimited: false },
        warehouses: { count: 1, unlimited: false },
        posTerminals: { count: 1, unlimited: false },
        products: { count: 100, unlimited: false },
        customers: { count: 200, unlimited: false },
        orders: { count: 500, unlimited: false },
        storageMb: { count: 512, unlimited: false },
        apiRequestsMonthly: { count: 1000, unlimited: false },
        aiRequestsMonthly: { count: 20, unlimited: false },
        automations: { count: 1, unlimited: false },
      },
      trialConfiguration: { trialDays: 0, isTrialEnabled: false },
    },
    {
      name: 'Starter Plan',
      slug: 'starter',
      tier: 'STARTER',
      description: 'Essential retail POS & inventory management for single-branch stores.',
      price: 15000,
      ...
      limits: {
        ...
        products: { count: 1000, unlimited: false },
        customers: { count: 1000, unlimited: false },
        orders: { count: 2000, unlimited: false },
        storageMb: { count: 2048, unlimited: false },
        apiRequestsMonthly: { count: 5000, unlimited: false },
        aiRequestsMonthly: { count: 100, unlimited: false },
        automations: { count: 5, unlimited: false },
      },
    ...
    },
    {
      ...
      slug: 'professional',
      tier: 'PROFESSIONAL',
      description: 'Growing multi-branch retailers needing CRM, Loyalty, and analytics.',
      price: 45000,
      yearlyDiscountPercent: 20,
      currency: 'NGN',
      status: 'ACTIVE',
      ...
      limits: {
        ...
        warehouses: { count: 3, unlimited: false },
        posTerminals: { count: 10, unlimited: false },
        products: { count: 10000, unlimited: false },
        customers: { count: 10000, unlimited: false },
        orders: { count: 15000, unlimited: false },
        storageMb: { count: 10240, unlimited: false },
        apiRequestsMonthly: { count: 50000, unlimited: false },
        aiRequestsMonthly: { count: 1000, unlimited: false },
        automations: { count: 25, unlimited: false },
      },
      trialConfiguration: { trialDays: 14, isTrialEnabled: true },
    },
    {
      ...
      slug: 'business',
      tier: 'BUSINESS',
      description: 'High-volume enterprises managing multiple warehouses and branches.',
      price: 120000,
      yearlyDiscountPercent: 20,
      currency: 'NGN',
      status: 'ACTIVE',
      ...
      limits: {
        users: { count: 100, unlimited: false },
        branches: { count: 20, unlimited: false },
        warehouses: { count: 10, unlimited: false },
        posTerminals: { count: 50, unlimited: false },
        products: { count: 50000, unlimited: false },
        customers: { count: 100000, unlimited: false },
        orders: { count: 100000, unlimited: false },
        storageMb: { count: 51200, unlimited: false },
        apiRequestsMonthly: { count: 500000, unlimited: false },
        aiRequestsMonthly: { count: 10000, unlimited: false },
        automations: { count: 100, unlimited: false },
      },
      trialConfiguration: { trialDays: 14, isTrialEnabled: true },
    },
    {
      ...
      slug: 'enterprise',
      tier: 'ENTERPRISE',
      description: 'Unlimited capacity, bespoke integrations, and dedicated SLA.',
      price: 350000,
      yearlyDiscountPercent: 20,
      currency: 'NGN',
      status: 'ACTIVE',
      ...
      trialConfiguration: { trialDays: 30, isTrialEnabled: true },
    },
  ];
  ...
  console.log('✓ 5 Standard SaaS Subscription Plans seeded.');
