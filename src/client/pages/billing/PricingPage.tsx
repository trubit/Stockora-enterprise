    ...
    <Box sx={{ p: { xs: 2, md: 4 }, maxWidth: 1440, mx: 'auto' }}>
              ...
              sx={{
                ...
                bgcolor:
                  billingInterval === 'MONTHLY'
                    ...
                    : 'transparent',
                boxShadow:
                  billingInterval === 'MONTHLY' ? '0 4px 14px rgba(139, 92, 246, 0.4)' : 'none',
                '&:hover': {
                  bgcolor:
                    billingInterval === 'MONTHLY'
                      ? 'linear-gradient(135deg, #8b5cf6 0%, #3b82f6 100%)'
              ...
              sx={{
                ...
                bgcolor:
                  billingInterval === 'YEARLY'
                    ...
                    : 'transparent',
                boxShadow:
                  billingInterval === 'YEARLY' ? '0 4px 14px rgba(139, 92, 246, 0.4)' : 'none',
                '&:hover': {
                  bgcolor:
                    billingInterval === 'YEARLY'
                      ? 'linear-gradient(135deg, #8b5cf6 0%, #3b82f6 100%)'
      ...
      <Grid container spacing={3} sx={{ mb: 6 }} alignItems="stretch">
        {plans.map((plan) => {
          ...
          return (
            <Grid item xs={12} sm={6} lg={3} key={plan._id} sx={{ display: 'flex' }}>
              <Card
                ...
                sx={{
                  ...
                  border: plan.isPopular
                    ? '2px solid rgba(139, 92, 246, 0.6) !important'
                    : undefined,
                }}
              >
                <Box>
              ...
              >
                ...
                >
                  ...
                  <Box sx={{ textAlign: 'right' }}>
                    <Typography
                      variant="h5"
                      sx={{ fontWeight: 900, fontFamily: 'monospace', color: '#8b5cf6' }}
                    >
              ...
              {(() => {
                const effectiveSubtotal =
                  billingInterval === 'YEARLY'
                    ...
                    : selectedPlan.price;
                const vatAmount = Math.round(effectiveSubtotal * 0.075);
                const totalDue = effectiveSubtotal + vatAmount;
                ...
                const gatewayVat = formatAmount(vatAmount, {
                  currency: gatewayCurrency,
                  fromCurrency: gatewayCurrency,
                  convert: false,
                });
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      <Typography
                        variant="subtitle1"
                        sx={{ fontWeight: 900, color: '#8b5cf6', fontFamily: 'monospace' }}
                      >
                        {gatewayTotal}
                      </Typography>
                    </Box>
