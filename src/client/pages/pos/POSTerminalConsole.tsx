...
export default function POSTerminalConsole() {
  ...
  const taxTotal = Math.round((subtotal - discountTotal) * 0.05 * 100) / 100;
        ...
        <DialogContent>
          {lastReceipt && (
            <Box sx={{ fontFamily: 'monospace', fontSize: '0.85rem' }}>
              ...
              {lastReceipt.header?.taxId && (
                <Typography variant="caption" align="center" display="block" color="text.secondary">
                  Tax ID / VAT: {lastReceipt.header.taxId}
                </Typography>
              )}
              ...
              >
                {lastReceipt.platformAttribution || 'Powered by Stockora Enterprise'}
              </Typography>
            </Box>
          )}
        </DialogContent>
