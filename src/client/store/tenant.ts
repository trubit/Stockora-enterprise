...
export const useTenantStore = create<TenantState>((set, get) => ({
  activeTenant: null,
  activeTenantId:
    typeof window !== 'undefined' ? localStorage.getItem('stockora_active_tenant_id') : null,
  activeTenantSlug:
    typeof window !== 'undefined' ? localStorage.getItem('stockora_active_tenant_slug') : null,
  userTenants: [],
  isLoading: false,
  error: null,
  ...
  setActiveTenant: (tenant) => {
    ...
    if (typeof window !== 'undefined') {
      ...
      localStorage.setItem('stockora_active_tenant_slug', tenant.slug);
    }
    set({
      activeTenant: tenant,
  ...
  switchTenant: async (targetTenantIdOrSlug: string) => {
    ...
    try {
      ...
      if (newToken) {
        localStorage.setItem('stockora_token', newToken);
      }
      if (activeTenant) {
